  ...
  const handleCheckout = async () => {
    try {
      if (!user) {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/checkout`, { // Changed to NEXT_PUBLIC_API_URL from http to https in the env files and in vercel environment variables
          method: "POST",
